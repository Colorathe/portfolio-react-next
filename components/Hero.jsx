      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <p className='py-4 text-gray-300 max-w-[70%] m-auto'>
            I'm front-end Developer especialzing in building excepcional digital
            experiencies. Currently, I'm focused on building responsive
          ...
          <div className='flex items-center justify-between max-w-[330px] m-auto py-4 text-dark'>
            ...
            <div className='rounded-full  -gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 bg-white'>
              <a target='_blank' href='https://github.com/Colorathe'>
                <FaGithub />
              </a>
            </div>
            <div className='rounded-full  -gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 bg-white'>
              <a
                target='_blank'
                href='https://docs.google.com/document/d/1nR9uczz08em-FiRN2ybhDb8kprced1qb8h3W3wfCCjs/edit?usp=sharing'
              >
